      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Приветствую! Я работаю на своём малом производстве, на ул.Софийской. Не беру предоплат, довольные клиенты оплачивают по итогу работы с улыбкой на лице.
            </motion.p>
            ...
            >
              Изготавливаю и устанавливаю современные гардеробные, мебель из ЛДСП: шкафы, тумбы, полки. С моими работами Вы сможете ознакомиться в галерее.
            </motion.p>
            ...
            >
              Являюсь мастером и изготавливаю перегородки и мебель самостоятельно на своем маленьком производстве, у меня нет огромных затрат на аренду магазина и оплату штата менеджеров, как итог - выгодное предложение.
            </motion.p>
          </div>
