      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Являемся мастерами и изготавливаем перегородки и мебель самостоятельно на своем маленьком производстве, у нас нет огромных затрат на аренду магазина и оплату штата менеджеров, как итог - выгодное предложение.
            </motion.p>
          </div>
